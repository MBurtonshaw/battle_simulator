...
**Required: PGAdmin
<br></br>
<p>Open PGAdmin and create a new database.</p>
<p>Right click to run a query tool on it, and open /server/database from this project. Run the .sql file there to create database tables.</p>
...
<p>Both back and front end servers should run, and the game should appear in the browser</p>
