...
**Required: PGAdmin
<br></br>
<p>Open PGAdmin and create a new database. Right click to run a query tool on it, and open /server/database from this project. Run the .sql file there to create database tables.</p>
